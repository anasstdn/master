                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                ...
                                <p class="font-italic text-white-op">
                                    Информационная Система для Сбора Данных v.1.0.0 &copy; <span class="">2020</span>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w600 font-size-xl" href="index.html">
                                        ...
                                        <span class="font-size-xl text-primary-dark">Master</span><span class="font-size-xl">ИССД</span>
                                    </a>
